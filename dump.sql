...
ALTER TABLE "exams" ADD CONSTRAINT "exams_fk1" FOREIGN KEY ("semesters_id") REFERENCES "semesters"("id");
ALTER TABLE "exams" ADD CONSTRAINT "exams_fk2" FOREIGN KEY ("teachers_id") REFERENCES "teachers"("id");
ALTER TABLE "exams" ADD CONSTRAINT "exams_fk3" FOREIGN KEY ("subjects_id") REFERENCES "subjects"("id");
